      ...
      >
        ...
        <section className="container mx-auto max-w-xl md:max-w-2xl lg:max-w-7xl mt-10 px-4 lg:px-15 pb-16 text-left grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-13">
          ...
          >
            ...
            <div className="mt-8 md:mt-9 relative w-full flex-1 overflow-hidden rounded-3xl min-h-48">
              <Image
                ...
                alt="Real-time financial transaction tracking dashboard showing live expense updates"
                title="Real-time financial transaction tracking dashboard showing live expense updates"
          ...
          >
            ...
            <div className="mt-8 md:mt-9 lg:mt-0 relative w-full flex-1 overflow-hidden rounded-3xl min-h-48">
              <Image
                ...
                alt="Automated wealth growth and savings goal progress visualization"
                title="Automated wealth growth and savings goal progress visualization"
          ...
          >
            ...
            <p className="text-sm max-w-lg">
              Bank-grade encryption meets seamless connectivity. Your data is
              your own, protected by modern security protocols.
            </p>
          </FadeUp>
        </section>
        ...
        <section className="container mx-auto max-w-xl md:max-w-2xl lg:max-w-7xl mt-10 px-4 lg:px-15">
          <div className="mx-auto max-w-xl md:max-w-2xl lg:max-w-7xl text-left grid grid-cols-1 lg:grid-cols-2 gap-15 lg:gap-18 bg-[#2D3133] dark:bg-[#23282B] rounded-4xl pt-15.5 pb-10 px-5 sm:px-13.5 min-h-120">
            <div className="text-center lg:text-left flex flex-col justify-center">
              ...
              >
                Start on your desktop, finalize on your mobile. Financial
                Atelier provides a continuous, fluid experience across every
                screen you own.
              </FadeUp>

              <FadeUp as="div" delay={0.6}>
                <Link
            ...
            <div className="relative h-70 lg:h-auto">
              <FadeUp delay={0.4} className="w-full h-full relative">
                <Image
          ...
          <div className="mx-auto max-w-xl md:max-w-2xl lg:max-w-5xl text-left grid grid-cols-1 lg:grid-cols-2 gap-15 px-5 sm:px-13.5">
            <div className="text-center lg:text-left flex flex-col justify-center">
              ...
              <div className="mt-8 sm:mt-7 lg:mt-9 space-y-7">
                ...
                <FadeUp
                  ...
                  className="text-sm sm:text-base text-secondary/80"
                >
                  Every pixel, every interaction, and every algorithm is
                  designed to foster a sense of calm authority over your
                  financial future. This isn&apos;t just management; it&apos;s a
                  financial atelier.
                </FadeUp>
              </div>
            </div>
            ...
            >
              <div className="absolute inset-0 rounded-full overflow-hidden m-4">
                <Image
                  alt="Artistic representation of the Financial Atelier's unique approach to wealth curation"
                  title="Artistic representation of the Financial Atelier's unique approach to wealth curation"
